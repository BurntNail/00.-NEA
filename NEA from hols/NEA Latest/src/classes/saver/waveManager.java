...
public class waveManager {
    ...
    private boolean atLeastOneEnemySpawned;
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                Thread checkThread = new Thread(() -> {
                    while(true) {
                        check(enemyActuals, pm, atLeastOneEnemySpawned);
                    }
                });
                checkThread.start();
    ...
    private static void check (ArrayList<Entity> enemyActuals, PlayerManager pm, boolean atLeastOneEnemySpawned) {
        ...
        if(enemyActuals.size() == 0 && atLeastOneEnemySpawned)
        {
            pm.hasWon();
            System.out.println("PM HAS WON");
        }
    }
