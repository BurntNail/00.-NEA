...
public class CfgReader { //config file reader
    ...
    private static final Pattern PROPERTY_REGEX = Pattern.compile("^ {4}[a-zA-Z0-9 \\._\\-,'!><]+=([ids])[a-zA-Z0-9 \\._\\-,'!><]+");
    private static final Pattern MODULE_START_REGEX = Pattern.compile("^module [a-zA-Z0-9 \\._\\-,'!><]+ \\{");
